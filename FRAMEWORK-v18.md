...
**Version:** 18.0 (Hermes Mini — Industry-Agnostic)
**Updated:** 2026-03-08

---

### V18 Changelog — Conversation Antibodies
- **Archetype Classifier:** Local (zero-API) classification of leads into archetype hashes (serviceCategory:urgency:personality:intent)
- **Pattern Library:** Hash map of proven conversation patterns with success tracking, persistence to JSON, min sample/conversion thresholds
- **Skeleton Generator:** Converts pattern skeletons into personalized responses (Tier 0 templates for simple steps, Tier 1 for complex)
- **Novelty Detector:** Monitors conversations for deviations from expected patterns; escalates to full AI on detection
- **Feedback Loop:** Every completed conversation strengthens/weakens its archetype pattern
- **Synthetic Seeds:** 11 pre-built archetypes from simulation data, marked as synthetic, low sample size for easy override
- **Cost Impact:** Antibody hits bypass API entirely (Tier 0) or use minimal Haiku (Tier 1) — further reduces token costs beyond V17
- **Safety:** Novelty detection ensures complex/unexpected conversations always escalate to full AI; no match = V17 fallback
- **Backward Compatible:** V17 tier routing preserved as fallback; V15/V16 routing intact
